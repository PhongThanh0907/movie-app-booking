...
const TinTuc = () => {
  return (
    ...
    <div className="tin__tuc" id="tinTuc">
      <Tabs
        defaultActiveKey="dienanh"
        id="uncontrolled-tab-example"
        className="mb-3"
      >
        <Tab eventKey="dienanh" title="Điện Ảnh 24h">
          <div>
            <div className="dien__Anh">
              <div className="row top__news container">
                ...
                <div className="col-12 col-sm-6">
                  ...
                  <p>
                    ...
                    trong một khung hình để ăn mừng thành tích ấn tượng
                  </p>
                </div>
              </div>
              <div className="row bottom__news container">
